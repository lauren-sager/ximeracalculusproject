...
\title{Chain Rule Activity}  %no trig
...
\begin{exercise}
    ...
    \end{tabular}
    \begin{enumerate}
        \item $\frac{d}{dx}[f(g(x))]$ at $x=1$
        \item $\frac{d}{dx}[g(f(x))]$ at $x=2$
        \item $\frac{d}{dx}[2f(x)+3g(x)]$ at $x=2$
        \item $\frac{d}{dx}[\sqrt{f(x)}]$ at $x=3$
        \item $\frac{d}{dx}[\frac{f(x)}{g(x)}]$ at $x=1$
        \item $\frac{d}{dx}[(f(x))^2g(x)]$ at $x=3$
    \end{enumerate}
\end{exercise}
