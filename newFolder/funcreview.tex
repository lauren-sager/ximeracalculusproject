...
% \end{exercise}
 ...
 In this problem, let $x$ denote the length of the base of a rectangle. Suppose the height of the rectangle is always half the length of its base.
    \begin{enumerate}
        ...
        \item What is the domain of the function $x$? Explain your answer.
...
\begin{exercise}
  \item Determine the domain of the function $\frac{\sqrt{x-1}}{x^2-9}$
\end{exercise}

\begin{exercise}
     \item Suppose \[ f(x)=\begin{cases} 
     3x-2 & x< 0 \\
      x^2+1 & 0< x\leq 4 \\
      0 &  4< x 
   \end{cases}
