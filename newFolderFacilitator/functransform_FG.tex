...
\title{Function Transformations Activity Facilitator Guide}
...
Students will be able to:
  \begin{itemize}
    \item Identify the changes made by a graph transformation using graphical tools
    \item Distiguish between horizontal and vertical tranformations of a graph.
    \item Identify zeros (solutions) and intervals of increasing and decreasing from a graph.
  \end{itemize}
\textbf{Prerequisite Knowledge:} Students will benefit most from this activity if they are comfortable with graphing functions (cartesian plane, axes, how to plot points, etc).  This activity can be used as a stand-alone review of transformation of functions, but should be reviewed to make sure all students get the information intended.  The end of the activity will give a tiny preview of the ideas of increasing and decreasing on a graph, looking forward to when we will discuss this from a calculus point of view later in the course.\\
\\
This is an activity where the students should work from the beginning, in order.  The final review questions can be omitted for  time.
...
\begin{enumerate}
    ...
    \textcolor{orange}{{\color{magenta} Students may not be able to articulate the ideas about horizontal vs. vertical stretch/compression at this point.  Question 5 starts to dig into this.}}
    \vspace{2in}
    ...
    \textcolor{orange}{This is where students should be starting to make sense of the horizontal and vertical aspects of these transformations. If students aren't quite getting there, asking some probing questions may be helpful. }
    \vspace{3in}\\
   ...
   Extension: Let's return to our $f(x)$ graph for a minute. 
        ...
        \textcolor{orange}{If groups get ahead, you can engage them on the question of whether the intervals should or shouldn't include the max/min points.  This is a preview of the ideas of increasing and decreasing, which we will cover from a calculus point of view later in the course.}\\
        \vspace{2in}
