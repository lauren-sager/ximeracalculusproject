...
\title{Concavity and Graphing Activity Facilitator Guide }
...
Students should be able to:
    \begin{itemize}
        \item Sketch the graph of a function based on a graph of its derivative
        \item Sketch the graph of a function based on given information about points, the first and the second derivatives.
        \item Find all intervals of increasing, decreasing, concave up, concave down, local extrema and inflections points.
        \item Sketch a graph based on the information gained from the first and second derivatives.
    \end{itemize}

\textbf{Prerequisite Knowledge:} This activity expects that students will know how to find information about a function using the first and second derivatives, and then coordinate that information to be able to sketch a graph.  One way to help students coordinate all of the information is to encourage them to draw a "straight line" draft of the graph first, connecting any points and using the correct increasing/decreasing direction. Student can then layer on the concavity. \\

With all four parts in question 3, this activity will get long.  Consider prioritizing or taking away some of these parts to condense the activity, if needed.
...
\begin{exercise}
    ...
    \textcolor{orange}{This question asks students not only to find information from the first derivative for increasing and decreasing, but also to recognize when the second derivative is positive vs negative from the graph of the first derivative.  It may help to sketch a quick graph of the 2nd derivative first.}
\end{exercise}
...
\begin{enumerate}
    ...
    \textcolor{orange}{Student can absolutely use a number line for the sign diagram - they are just hard to replicate in type!}
