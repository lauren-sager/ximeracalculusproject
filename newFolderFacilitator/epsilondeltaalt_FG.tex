...
\title{Epsilon-Delta Alternate Activity Facilitator Guide}
...
\textcolor{orange}{\textbf{This alternate activity is meant to be a second option alongside the Continuity Activity.}}

\textbf{Student Learning Outcomes}
Students should be able to:
    \begin{itemize}
        \item Follow scaffolded steps to create a proof of the limit of an affine ($mx+b$) function.
        \item Find an appropriate $\delta$ for the setup of the mathematical definition of a limit for an affine function.
    \end{itemize}

\textbf{Prerequisite Knowledge:} This activity is meant for students who are \textit{comfortable} with limits and continuity and looking for more in-depth engagement with the activity.  No prior knowledge of formal logic is required, but support may be needed for students unfamiliar with formal logic.  Prior knowledge of limits and the continuity of linear functions is helpful.  Note that this is an \textit{alternate} activity, and $\epsilon$-$\delta$ proofs will not be directly assessed.\\

If it has been a while since you have done proofs, I'd suggest that you take a look at this activity in more detail before class.  The final problem is by far the most difficult.  Many students will not choose this activity, but making sure at least one member of the teaching team is prepared for the small number who will is helpful.
