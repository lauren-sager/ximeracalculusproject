...
Students should be able to:
    \begin{itemize}
        \item Evaluate limits of the form $\frac00$ or $\frac{\pm\infty}{\pm\infty}$ using l'Hopital's rule.
        \item Determine when function dominance or l'Hopital's rule apply to basic limits.
        \item Find vertical asymptotes of a rational function.
    \end{itemize}

\textbf{Prerequisite Knowledge:} This activity expects that students will have knowledge of l'Hopital's rule and indeterminate forms of limits.  Students need to know how to take derivatives of functions and limits of functions not in the indeterminate forms. \\

This activity includes a section (1) on function dominance (colloquially known as the ``fishy'' diagram in some corners of the departments).  If you are not covering function dominance explicitly, this can be a chance to introduce it, or it may be skipped.  The hope is that by introducing examples and non-examples, students will not try to overgeneralize the argument. \\

There are many examples in (2). These can be cut down or prioritized based on time.
