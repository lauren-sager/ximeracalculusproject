...
\title{Continuity Activity Facilitator Guide}
...
\begin{itemize}
  \item Use the definition of continuous functions to determine if statements are true or false.
  \item Sketch a graph of a function given information about continuity, limits and function values.
\end{itemize}
\textbf{Prerequisite Knowledge:} Students will need to know the definition of continuity and be comfortable with graphs of functions that are or are not continuous.  Knowledge of the types of discontinuity (removable,jump, and infinite) is helpful, but knowing the names are not required.
...
\begin{exercise}
     ...
     \textcolor{orange}{These problems tend to be very hard for students because they have not been exposed to the logic of proofs.  We are not looking for students to write full proofs here, just give explanations that help them make sense of the topics. If students are totally stuck, rephrasing the true/false to always/sometimes/never may help with intuition, although this will likely be difficult to translate the sometimes case to true/false, and that's ok.  \\
     Explaining to students why a couterexample is enough for a false proof but not for a true proof is also a difficult discussion.  We try to avoid this by giving them instructions to help, but students may still try to ``prove'' by example.}
    \begin{enumerate}
        ...
        \textcolor{blue}{Assuming that the function is not continous at $x=c$ means that either 
          ...
          \textcolor{orange}{We would not expect students to know this, but this is the contrapositive of the definition of continuity.}
