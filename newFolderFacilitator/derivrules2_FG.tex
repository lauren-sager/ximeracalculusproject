...
\title{Derivative Rules Part 2 Activity Facilitator Guide}
...
Students will be able to:\\
    \begin{itemize} 
        \item Take derivatives of functions requiring the product and quotient rules.
        \item Find the equation of a tangent line to a function requiring use of the product or quotient rules.
    \end{itemize}

\textbf{Prerequisite Knowledge:} This activity assumes students have been exposed to all derivative rules except for the chain rule.\\

The first two questions are meant to reinforce the derivative rules without the added context of function expressions.  These problems tend to stump students, especially since this is likely one of the first times they have seen ``table problems''.  Encourage students to write out the appropriate rule with the function names, and try to go from there.  The remaining problems are more standard derivative problems for practice.
...
\begin{exercise}
    ...
    \textcolor{orange}{The instruction here to pick a rule and justify ahead of time is not just a throw-away suggestion: we are trying to encourage students to be reflective mathematicians.  Hopefully, especially for students who haven't seen these rules before, the added step of reflection will help when they see functions on assessments in the future.}
    \begin{enumerate}
