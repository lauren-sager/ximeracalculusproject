...
\title{Graphing Activity Facilitator Guide}
...
\textbf{Student Learning Objectives}
  ...
  \begin{itemize}
    \item Identify and classify critical points of a function from its derivative.
    \item Create a sign diagram for a function from its derivative.
    \item Sketch a function's general shape from its derivative.
    \item Identify inflection points and concavity from the second derivative.
  \end{itemize}
\textbf{Prerequisite Knowledge} This activity expects students to have knowledge of the first and second derivative tests, and how the first and second derivatives relate to increasing/decreasing and concavity of functions, respectively.  
...
\begin{exercise}
    ...
    \begin{enumerate}
        ...
        \textcolor{orange}{These problems are likely to still confuse students.  We are not expecting full proofs from students, but they should be explaining their answer.  If students are still stuck, try swapping to an "always-sometimes-never" framing of the question.  This may help students identify cases where the second statement, in particular, fails.}
    \end{enumerate}
\end{exercise}
...
\begin{exercise}
    ...
    \textcolor{orange}{This problem walks the line of trying to make sure students are getting more complicated examples than just polynomials and not being \textit{too} complicated.  However, we've been told many times that students struggle with this question.  Consider giving extra support on this question, or if you'd prefer that students get through more quickly, drop the division by $x-2$ and the asymptote.}
    \begin{enumerate}
        ...
        \textcolor{blue}{This question will likely stretch students.  For groups that are very stuck, suggest they sketch the graph first and then return to this question.}
...
\end{tikzpicture}
    ...
    \textcolor{orange}{This is another question meant to stretch students' understanding.  Most will only get that the 2nd derivative test is inconclusive.  This is a reasonable answer for students and what would be expected on an exam/quiz.  The further reasoning is a good thing to prompt groups that are ahead or strong in their understanding to think more about.}
    ...
    \textcolor{orange}{This is a little preview of the idea of antiderivatives, which will be coming soon!}
    \end{enumerate}
