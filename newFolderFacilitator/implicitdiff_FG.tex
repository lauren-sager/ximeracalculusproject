...
Students will be able to:
  \begin{itemize}
    \item Find the derivative of an implicit expression in $x,y$ using implicit differentiation.
    \item Interpret the derivative of an implicit expression.
    \item Find the tangent line to an implicit curve in $x,y$ given a point.
    \item Identify tangent lines that have particular qualities based on the graph.
  \end{itemize}
\textbf{Prerequisite Knowledge:} Students are expected to have knowledge of how to do the process of implicit differentiation.  In particular, students should have knowledge of the symbolic process of implicit differentiation.  This activity seeks to make some connection to the graphical aspects of implicit differentiation that students may not get in a lecture discussion of implicit differentiation.\\
\\
Task 1 is the more involved investigation here.  If students do not reach task 2, this is a simpler exercise for them to try on their own.
