...
\title{Limit Laws Activity Facilitator Guide}
...
Students will be able to:
  \begin{itemize}
    \item Evaluate limits of continuous functions using the limit laws.
    \item Identify the limit laws used when evaluating a continuous function limit.
...
\textbf{Prerequisite Knowledge:} This activity assumes that students have been introduced to the limit laws (sum, difference, product, quotient, power, constant multiple). Questions 1 and 3 explicitly rely on the limit laws, while 2 uses it more implicitly.  The final question is a challenge question for groups that get ahead. 
...
\begin{exercise}
    ...
    \textcolor{orange}{We will generally not ask students to label the limit laws after this activity.  This is an excellent opportunity to ask students to pull out their notes from lecture to review what the laws are. }
  \begin{enumerate}
   ...
   \item $\displaystyle \lim_{x\rightarrow 3} \frac{x^2-9}{x+3}$\\ 
     \textcolor{blue}{\begin{tabular}{c|c}
       $\displaystyle=\frac{\lim_{x\rightarrow 3} x^2-\lim_{x\rightarrow 3}9}{\lim_{x\rightarrow3}x+\lim_{x\rightarrow 3}3}$  & Quotient law, sum law, difference law  \\
        $=\displaystyle \frac{(\lim_{x\rightarrow 3} x)^2-\lim_{x\rightarrow 3}9}{\lim_{x\rightarrow3}x+\lim_{x\rightarrow 3}3}$ & power law\\
        $=\frac{3^2-9}{3+3}$
        $=\frac{0}{6}=0$ & 
    \end{tabular}}
    ...
    \textcolor{blue}{\begin{tabular}{c|c}
       $\displaystyle=\frac{\lim_{x\rightarrow 5} x^2-\lim_{x\rightarrow 5}9}{\lim_{x\rightarrow 5}x-\lim_{x\rightarrow 5}3}$  & Quotient law, sum law, difference law  \\
        $=\displaystyle \frac{(\lim_{x\rightarrow 5} x)^2-\lim_{x\rightarrow 5}9}{\lim_{x\rightarrow5}x-\lim_{x\rightarrow 5}3}$ & power law\\
        $=\frac{5^2-9}{5-3}$
        $=\frac{16}{2}=8$ & 
        \end{tabular}}
