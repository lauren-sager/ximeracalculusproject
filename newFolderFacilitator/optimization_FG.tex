...
\begin{exercise}
    ...
    \begin{enumerate}
        ...
        \textcolor{orange}{The cost function and its relationship with the surface area function may not be obvious to all students.  Use their drawing as a way to help them make sense of it.}
