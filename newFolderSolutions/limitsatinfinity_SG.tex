...
\title{Limits at Infinity Activity Solution Guide}
...
\begin{exercise}
  ...
  \begin{enumerate}
    ...
    \item $\displaystyle\lim_{x\rightarrow -\infty} (x^2-7x^5)$\\
    \textcolor{blue}{As $x\rightarrow -\infty$, $x^2\rightarrow \infty$, and $x^5\rightarrow -\infty$.  $\infty-(-\infty\rightarrow \infty$)}
