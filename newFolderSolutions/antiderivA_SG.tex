...
\title{Antiderivative Activity - Acceleration Variant Solution Guide}
...
\begin{exercise}
    ...
    \begin{enumerate}
        ...
        {\color{blue} $v(t)=51.333+17t$ (Units: $\frac{ft}{sec}+\frac{ft}{sec^2}{(sec)}=\frac{ft}{sec}$}\\
        ...
        {\color{blue} $s(t)=51.333t+\frac{17}{2}t^2$ (Check: $\frac{ft}{sec}(sec)+\frac{ft}{sec}(sec)^2=ft$ }\\
        ...
        {\color{blue} $v(t)=100$ so $100=51.333+17t$\\
        Solve for $t$: $48.667=17t$, or $t\approx 2.86$ seconds \\
        The car hits $100 \frac{ft}{sec}$ at $t=2.86$ seconds.  We sub this into $s(t)$ to learn how far the car has traveled:\\
        $s(2.86)=51.333(2.86)+\frac{17}{2}(2.86)^2\approx216.34$ feet.}\\
    \end{enumerate}
\end{exercise}
\begin{exercise}
    ...
    \begin{enumerate}
        ...
        {\color{blue} $32-32t>0$ when $32t<32$, or $0\leq t<1$.  This means that the ball is moving upwards from $t=0$ until $t=1$.}\\

        \item[B.] Find an antiderivative (indefinite integral), $s$, of $v$ that satisfies $s(0)=0$.\\
        {\color{blue} $s(t)=\int v(t)dt=32t-16t^2+c$\\
        ...
        {\color{blue} $v(\frac{1}{2})=32-16=16$\\
        ...
        {\color{blue} $s(2)=32(2)-16(2)^2=64-64=0$\\
        $s(0)=0$\\
